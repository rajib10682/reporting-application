...
@Entity
@Table(name = "adjustment_data")
public class AdjustmentData {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long recordId;
    
    @Column(name = "adjustment_session_id", nullable = false)
    private Long adjustmentSessionId;
    ...
    public Long getAdjustmentSessionId() { return adjustmentSessionId; }
    public void setAdjustmentSessionId(Long adjustmentSessionId) { this.adjustmentSessionId = adjustmentSessionId; }
